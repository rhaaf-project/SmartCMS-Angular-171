...
@Component({
    ...
    imports: [NgIf, HighlightModule, IconBellComponent, IconCodeComponent],
})
        ...
        if (type === 1) {
            ...
            for (currentStep = 0; currentStep < steps.length; ) {
                ...
                if (result.value) {
                    ...
                    currentStep++;
                } else if (result.dismiss === Swal.DismissReason.cancel.toString()) {
                    currentStep--;
                } else {
                    break;
                }
            ...
            Swal.fire({
                ...
                if (result.dismiss === Swal.DismissReason.timer.toString()) {
